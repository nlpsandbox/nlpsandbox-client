...
from annotator import rest
from annotator.configuration import Configuration
from annotator.exceptions import ApiTypeError, ApiValueError, ApiException
from annotator.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = HealthCheckApi()
        api_instance.get_health_check  # this is an instance of the class Endpoint
        api_instance.get_health_check()  # this invokes api_instance.get_health_check.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_health_check.callable or self.callable in this class

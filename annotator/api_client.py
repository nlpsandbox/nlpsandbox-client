...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ServiceApi()
        api_instance.service  # this is an instance of the class Endpoint
        api_instance.service()  # this invokes api_instance.service.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.service.callable or self.callable in this class

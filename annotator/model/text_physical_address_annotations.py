...
class TextPhysicalAddressAnnotations(ModelNormal):
    ...
    def __init__(self, text_physical_address_annotations, *args, **kwargs):  # noqa: E501
        ...
        Args:
            text_physical_address_annotations ([TextPhysicalAddressAnnotation]): A list of text physical address annotations

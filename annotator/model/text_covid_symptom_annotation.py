...
class TextCovidSymptomAnnotation(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, start, length, text, confidence, condition, certainty, *args, **kwargs):  # noqa: E501

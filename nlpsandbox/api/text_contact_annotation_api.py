...
class TextContactAnnotationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_text_contact_annotations_endpoint = _Endpoint(
            settings={
                'response_type': (TextContactAnnotationResponse,),
                'auth': [],
                'endpoint_path': '/textContactAnnotations',
                'operation_id': 'create_text_contact_annotations',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'text_contact_annotation_request': 'body',
                },
    ...
    def create_text_contact_annotations(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_text_contact_annotations(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            text_contact_annotation_request (TextContactAnnotationRequest): [optional]
        ...
        return self.create_text_contact_annotations_endpoint.call_with_http_info(**kwargs)

...
class DeidentifiedNoteApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_deidentified_notes_endpoint = _Endpoint(
            settings={
    ...
    def create_deidentified_notes(
        ...
        **kwargs
        ...
        return self.create_deidentified_notes_endpoint.call_with_http_info(**kwargs)

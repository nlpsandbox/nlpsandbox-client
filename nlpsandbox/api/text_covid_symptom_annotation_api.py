...
class TextCovidSymptomAnnotationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_text_covid_symptom_annotations_endpoint = _Endpoint(
            settings={
                'response_type': (TextCovidSymptomAnnotationResponse,),
                'auth': [],
                'endpoint_path': '/textCovidSymptomAnnotations',
                'operation_id': 'create_text_covid_symptom_annotations',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'text_covid_symptom_annotation_request': 'body',
                },
    ...
    def create_text_covid_symptom_annotations(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.create_text_covid_symptom_annotations(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            text_covid_symptom_annotation_request (TextCovidSymptomAnnotationRequest): [optional]
        ...
        return self.create_text_covid_symptom_annotations_endpoint.call_with_http_info(**kwargs)

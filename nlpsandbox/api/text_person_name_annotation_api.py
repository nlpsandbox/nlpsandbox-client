...
class TextPersonNameAnnotationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_text_person_name_annotations_endpoint = _Endpoint(
            settings={
    ...
    def create_text_person_name_annotations(
        self,
        **kwargs
    ):
        ...
        return self.create_text_person_name_annotations_endpoint.call_with_http_info(**kwargs)

...
class DeidentificationStep(ModelNormal):
    ...
    allowed_values = {
        ('annotation_types',): {
            ...
            'PHYSICAL_ADDRESS': "text_physical_address",
            'ID': "text_id",
    ...
    def __init__(self, annotation_types, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            annotation_type_mask_config ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Configuration for the \"annotation type\" strategy. E.g. \"John Smith lives at 123 Main St\" -> \"[PERSON_NAME] lives at [PHYSICAL_ADDRESS]\".. [optional]  # noqa: E501

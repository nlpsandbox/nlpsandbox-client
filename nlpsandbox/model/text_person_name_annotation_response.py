...
class TextPersonNameAnnotationResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, text_person_name_annotations, *args, **kwargs):  # noqa: E501
        """TextPersonNameAnnotationResponse - a model defined in OpenAPI

        Args:
            text_person_name_annotations ([TextPersonNameAnnotation]): A list of person name annotations
    ...
    @convert_js_args_to_python_args
    def __init__(self, text_person_name_annotations, *args, **kwargs):  # noqa: E501
        """TextPersonNameAnnotationResponse - a model defined in OpenAPI

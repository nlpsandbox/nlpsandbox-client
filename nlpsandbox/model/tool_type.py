...
class ToolType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): The type of this tool., must be one of ["nlpsandbox:contact-annotator", "nlpsandbox:covid-symptom-annotator", "nlpsandbox:data-node", "nlpsandbox:date-annotator", "nlpsandbox:id-annotator", "nlpsandbox:location-annotator", "nlpsandbox:person-name-annotator", "nlpsandbox:phi-annotator", "nlpsandbox:phi-deidentifier", ]  # noqa: E501

        Keyword Args:
            value (str): The type of this tool., must be one of ["nlpsandbox:contact-annotator", "nlpsandbox:covid-symptom-annotator", "nlpsandbox:data-node", "nlpsandbox:date-annotator", "nlpsandbox:id-annotator", "nlpsandbox:location-annotator", "nlpsandbox:person-name-annotator", "nlpsandbox:phi-annotator", "nlpsandbox:phi-deidentifier", ]  # noqa: E501

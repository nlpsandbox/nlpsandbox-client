...
class TextContactAnnotationResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, text_contact_annotations, *args, **kwargs):  # noqa: E501
        """TextContactAnnotationResponse - a model defined in OpenAPI

        Args:
            text_contact_annotations ([TextContactAnnotation]): A list of contact annotations
    ...
    @convert_js_args_to_python_args
    def __init__(self, text_contact_annotations, *args, **kwargs):  # noqa: E501
        """TextContactAnnotationResponse - a model defined in OpenAPI

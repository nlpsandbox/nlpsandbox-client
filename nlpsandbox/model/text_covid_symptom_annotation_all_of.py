...
class TextCovidSymptomAnnotationAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, condition, certainty, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, condition, certainty, *args, **kwargs):  # noqa: E501
        """TextCovidSymptomAnnotationAllOf - a model defined in OpenAPI

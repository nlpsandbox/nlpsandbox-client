...
class AnnotationSet(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'text_location_annotations': ([TextLocationAnnotation],),  # noqa: E501
            'text_id_annotations': ([TextIdAnnotation],),  # noqa: E501
            'text_contact_annotations': ([TextContactAnnotation],),  # noqa: E501
        }
    ...
    attribute_map = {
        'text_date_annotations': 'textDateAnnotations',  # noqa: E501
        'text_person_name_annotations': 'textPersonNameAnnotations',  # noqa: E501
        'text_location_annotations': 'textLocationAnnotations',  # noqa: E501
        'text_id_annotations': 'textIdAnnotations',  # noqa: E501
        'text_contact_annotations': 'textContactAnnotations',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, text_date_annotations, text_person_name_annotations, text_location_annotations, text_id_annotations, text_contact_annotations, *args, **kwargs):  # noqa: E501
        """AnnotationSet - a model defined in OpenAPI

        Args:
            text_date_annotations ([TextDateAnnotation]): Date annotations in a text
            text_person_name_annotations ([TextPersonNameAnnotation]): Person name annotations in a text
            text_location_annotations ([TextLocationAnnotation]): Location annotations in a text
            text_id_annotations ([TextIdAnnotation]): ID annotations in a text
            text_contact_annotations ([TextContactAnnotation]): Contact annotations in a text
    ...
    @convert_js_args_to_python_args
    def __init__(self, text_date_annotations, text_person_name_annotations, text_location_annotations, text_id_annotations, text_contact_annotations, *args, **kwargs):  # noqa: E501
        """AnnotationSet - a model defined in OpenAPI

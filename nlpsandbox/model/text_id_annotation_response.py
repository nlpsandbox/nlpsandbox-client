...
class TextIdAnnotationResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, text_id_annotations, *args, **kwargs):  # noqa: E501
        """TextIdAnnotationResponse - a model defined in OpenAPI

        Args:
            text_id_annotations ([TextIdAnnotation]): A list of ID annotations
    ...
    @convert_js_args_to_python_args
    def __init__(self, text_id_annotations, *args, **kwargs):  # noqa: E501
        """TextIdAnnotationResponse - a model defined in OpenAPI

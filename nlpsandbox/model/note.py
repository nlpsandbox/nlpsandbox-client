...
class Note(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, identifier, text, type, patient_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, identifier, text, type, patient_id, *args, **kwargs):  # noqa: E501
        """Note - a model defined in OpenAPI

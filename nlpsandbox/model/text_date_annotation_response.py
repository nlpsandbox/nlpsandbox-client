...
class TextDateAnnotationResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, text_date_annotations, *args, **kwargs):  # noqa: E501
        """TextDateAnnotationResponse - a model defined in OpenAPI

        Args:
            text_date_annotations ([TextDateAnnotation]): A list of date annotations
    ...
    @convert_js_args_to_python_args
    def __init__(self, text_date_annotations, *args, **kwargs):  # noqa: E501
        """TextDateAnnotationResponse - a model defined in OpenAPI

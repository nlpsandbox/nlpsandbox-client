...
class NoteApi(object):
    ...
    def create_note(self, dataset_id, fhir_store_id, **kwargs):  # noqa: E501
        ...
        return self.create_note_with_http_info(dataset_id, fhir_store_id, **kwargs)  # noqa: E501

    def create_note_with_http_info(self, dataset_id, fhir_store_id, **kwargs):  # noqa: E501
        """Create a note  # noqa: E501

        Create a note  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_note_with_http_info(dataset_id, fhir_store_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('dataset_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `dataset_id` when calling `create_note`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/datasets/{datasetId}/fhirStores/{fhirStoreId}/fhir/Note', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_note(self, dataset_id, fhir_store_id, note_id, **kwargs):  # noqa: E501
        ...
        :param str dataset_id: The ID of the dataset (required)
        :param str fhir_store_id: The ID of the FHIR store (required)
        :param str note_id: The ID of the note (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_note_with_http_info(dataset_id, fhir_store_id, note_id, **kwargs)  # noqa: E501

    def delete_note_with_http_info(self, dataset_id, fhir_store_id, note_id, **kwargs):  # noqa: E501
        """Delete a note  # noqa: E501

        Deletes the note specified  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_note_with_http_info(dataset_id, fhir_store_id, note_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('dataset_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['dataset_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `dataset_id` when calling `delete_note`")  # noqa: E501
        # verify the required parameter 'fhir_store_id' is set
        if self.api_client.client_side_validation and ('fhir_store_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['fhir_store_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `fhir_store_id` when calling `delete_note`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/datasets/{datasetId}/fhirStores/{fhirStoreId}/fhir/Note/{noteId}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_note(self, dataset_id, fhir_store_id, note_id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_note_with_http_info(dataset_id, fhir_store_id, note_id, **kwargs)  # noqa: E501

    def get_note_with_http_info(self, dataset_id, fhir_store_id, note_id, **kwargs):  # noqa: E501
        """Get a note  # noqa: E501

        Returns the note specified  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_note_with_http_info(dataset_id, fhir_store_id, note_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('dataset_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['dataset_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `dataset_id` when calling `get_note`")  # noqa: E501
        # verify the required parameter 'fhir_store_id' is set
        if self.api_client.client_side_validation and ('fhir_store_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['fhir_store_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `fhir_store_id` when calling `get_note`")  # noqa: E501
        # verify the required parameter 'note_id' is set
        if self.api_client.client_side_validation and ('note_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['note_id'] is None):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/datasets/{datasetId}/fhirStores/{fhirStoreId}/fhir/Note/{noteId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_notes(self, dataset_id, fhir_store_id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_notes_with_http_info(dataset_id, fhir_store_id, **kwargs)  # noqa: E501

    def list_notes_with_http_info(self, dataset_id, fhir_store_id, **kwargs):  # noqa: E501
        """List notes  # noqa: E501

        Returns the notes in a FHIR store  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_notes_with_http_info(dataset_id, fhir_store_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PageOfNotes, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('dataset_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['dataset_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `dataset_id` when calling `list_notes`")  # noqa: E501
        # verify the required parameter 'fhir_store_id' is set
        if self.api_client.client_side_validation and ('fhir_store_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['fhir_store_id'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 10:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `list_notes`, must be a value greater than or equal to `10`")  # noqa: E501
        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `list_notes`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/datasets/{datasetId}/fhirStores/{fhirStoreId}/fhir/Note', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PageOfNotes',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),

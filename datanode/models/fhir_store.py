...
class FhirStore(object):
    ...
    def __init__(self, name=None, local_vars_configuration=None):  # noqa: E501
        """FhirStore - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this FhirStore.  # noqa: E501

        Resource name of the FHIR store, of the form datasets/{datasetId}/fhirStores/{fhirStoreId}  # noqa: E501

        :return: The name of this FhirStore.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this FhirStore.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FhirStore):
            return False

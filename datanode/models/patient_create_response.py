...
class PatientCreateResponse(object):
    ...
    def __init__(self, name=None, local_vars_configuration=None):  # noqa: E501
        """PatientCreateResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this PatientCreateResponse.  # noqa: E501

        The resource name of the FHIR patient, of the form datasets/{datasetId}/fhirStores/{fhirStoreId}/Patient/{PatientId}  # noqa: E501

        :return: The name of this PatientCreateResponse.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PatientCreateResponse.

        The resource name of the FHIR patient, of the form datasets/{datasetId}/fhirStores/{fhirStoreId}/Patient/{PatientId}  # noqa: E501

        :param name: The name of this PatientCreateResponse.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatientCreateResponse):
            return False

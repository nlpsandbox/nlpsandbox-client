...
class AnnotationStoreCreateResponse(object):
    ...
    def __init__(self, name=None, local_vars_configuration=None):  # noqa: E501
        """AnnotationStoreCreateResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this AnnotationStoreCreateResponse.  # noqa: E501

        The resource name of the annotation store, of the form datasets/{datasetId}/annotationStores/{annotationStoreId}  # noqa: E501

        :return: The name of this AnnotationStoreCreateResponse.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnnotationStoreCreateResponse):
            return False

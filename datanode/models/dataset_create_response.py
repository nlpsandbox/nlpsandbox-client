...
class DatasetCreateResponse(object):
    ...
    def __init__(self, name=None, local_vars_configuration=None):  # noqa: E501
        """DatasetCreateResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this DatasetCreateResponse.  # noqa: E501

        The name of the dataset  # noqa: E501

        :return: The name of this DatasetCreateResponse.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DatasetCreateResponse):
            return False

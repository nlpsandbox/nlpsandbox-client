...
class PageOfPatientsAllOf(object):
    ...
    def __init__(self, patients=None, local_vars_configuration=None):  # noqa: E501
        """PageOfPatientsAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PageOfPatientsAllOf):
            return False

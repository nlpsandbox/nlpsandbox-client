...
class ResourceSource(object):
    ...
    def __init__(self, name=None, local_vars_configuration=None):  # noqa: E501
        """ResourceSource - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this ResourceSource.  # noqa: E501

        Full path of an API resource  # noqa: E501

        :return: The name of this ResourceSource.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResourceSource):
            return False

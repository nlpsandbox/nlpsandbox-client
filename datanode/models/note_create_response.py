...
class NoteCreateResponse(object):
    ...
    def __init__(self, name=None, local_vars_configuration=None):  # noqa: E501
        """NoteCreateResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NoteCreateResponse):
            return False

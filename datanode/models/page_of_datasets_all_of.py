...
class PageOfDatasetsAllOf(object):
    ...
    def __init__(self, datasets=None, local_vars_configuration=None):  # noqa: E501
        """PageOfDatasetsAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def datasets(self):
        """Gets the datasets of this PageOfDatasetsAllOf.  # noqa: E501

        An array of datasets  # noqa: E501

        :return: The datasets of this PageOfDatasetsAllOf.  # noqa: E501
        :rtype: list[Dataset]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PageOfDatasetsAllOf):
            return False

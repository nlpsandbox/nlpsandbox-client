...
class FhirStoreCreateResponse(object):
    ...
    def __init__(self, name=None, local_vars_configuration=None):  # noqa: E501
        """FhirStoreCreateResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this FhirStoreCreateResponse.  # noqa: E501

        The resource name of the FHIR store, of the form datasets/{datasetId}/fhirStores/{fhirStoreId}  # noqa: E501

        :return: The name of this FhirStoreCreateResponse.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this FhirStoreCreateResponse.

        The resource name of the FHIR store, of the form datasets/{datasetId}/fhirStores/{fhirStoreId}  # noqa: E501

        :param name: The name of this FhirStoreCreateResponse.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FhirStoreCreateResponse):
            return False
